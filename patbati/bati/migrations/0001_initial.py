...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('finition', models.ForeignKey(limit_choices_to={'id_type__code': 'FIN'}, on_delete=django.db.models.deletion.CASCADE, related_name='finition_materiaux_fin', to='bati.nomenclature')),
                ('materiaux_fin', models.ForeignKey(limit_choices_to={'id_type__code': 'MAT_FIN'}, on_delete=django.db.models.deletion.CASCADE, related_name='materiaux_fin_finition', to='bati.nomenclature')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('materiaux_ge', models.ForeignKey(limit_choices_to={'id_type__code': 'MAT_GE'}, on_delete=django.db.models.deletion.CASCADE, related_name='materiaux_ge_mise_en_oeuvre', to='bati.nomenclature')),
                ('mise_en_oeuvre', models.ForeignKey(limit_choices_to={'id_type__code': 'MEOEUVRE'}, on_delete=django.db.models.deletion.CASCADE, related_name='mise_en_oeuvre_materiaux_ge', to='bati.nomenclature')),
            ],
        ),
        migrations.CreateModel(
            name='Illustration',
        ...
        migrations.AddField(
            model_name='bati',
            name='protection',
            field=models.ManyToManyField(limit_choices_to={'id_type__code': 'PROT'}, related_name='batiments_protection', to='bati.nomenclature'),
        ),
        migrations.AddField(
            model_name='bati',
            name='risques_nat',
        ...
        migrations.AddField(
            model_name='bati',
            name='type_bat',
            field=models.ForeignKey(blank=True, limit_choices_to={'id_type__code': 'TYPE_BAT'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='batiments_type', to='bati.nomenclature'),
        ),
        migrations.AddField(
