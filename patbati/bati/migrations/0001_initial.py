# Generated by Django 5.2.1 on 2025-06-24 06:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auteur', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ilustration_auteur', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='bati',
            name='risques_nat',
            field=models.ManyToManyField(limit_choices_to={'id_type__code': 'RISQUE'}, related_name='batiments_risquenat', to='bati.nomenclature'),
        ),
        migrations.AddField(
            model_name='bati',
            name='secteur',
